<script lang="ts">
  ...
  function hidePopper(game?: string) {
...
<div class="items-center flex flex-col flex-1">
    ...
    <div class="h-max flex flex-col items-center relative">
      ...
      <div class="grid grid-cols-3">
        <img on:click={() => hidePopper("valorant")} class="p-4 hover:scale-110 hover:cursor-pointer z-10 ease-out duration-500" src="Valorant.png" />
        <img on:click={() => hidePopper("league")} class="p-4 hover:scale-110 hover:cursor-pointer z-10 ease-out duration-500" src="League.png" />
        <img on:click={() => hidePopper("overwatch")} class="p-4 hover:scale-110 hover:cursor-pointer z-10 ease-out duration-500" src="Overwatch 2.png" />
      </div>
      <div
        bind:this={popout}
        role="dialog"
