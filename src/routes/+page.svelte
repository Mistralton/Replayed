...
<div class="flex flex-col justify-center items-center flex-1 mt-[20vh]">
  ...
  <Choose />
  <p class="text-white max-w-3xl text-center">From MOBAs like League of Legends, to FPS games like Valorant, our website currently supports several different games with more coming soon!</p>
